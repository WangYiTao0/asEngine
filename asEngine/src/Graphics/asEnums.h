...
//Common blendmodes used across multiple system
enum BLENDMODE
{
	BLENDMODE_OPAQUE,//opaque 
	BLENDMODE_ALPHA,
	BLENDMODE_PREMULTIPLIED,//without Premultiplied Alpha texture can't Filtering 
	BLENDMODE_ADDITIVE,
	BLENDMODE_COUNT
};
...
enum RENDERPASS
{
	...
	RENDERPASS_ENVMAPCAPTURE, //environment capture
	RENDERPASS_SHADOW,
