...
#include "GPUMapping\ShaderInterop_GPUSortLib.h"
...
namespace as
{
	namespace asGPUSortLib
	{
		...
		void Initialize()
		{
			...
			asRenderer::GetDevice()->CreateBuffer(&bd, nullptr, &sortCB);
			...
			asRenderer::GetDevice()->CreateBuffer(&bd, nullptr, &indirectBuffer);
		}
