...
namespace as
{
	namespace asGraphics
	{
		...
		private:
			...
			std::unordered_map<asCPUHandle, VmaAllocation> vma_allocations;
		...
		public:
			GraphicsDevice_Vulkan(asPlatform::window_type window, bool fullscreen = false, bool debuglayer = false);
